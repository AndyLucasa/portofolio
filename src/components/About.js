    ...
    <div className="About bg-transparent pl-48 h-full grid grid-cols-3 z-10"> 
      ...
      <div className=" col-span-2  ">
        ...
        <div className="Text w-4/5 mx-10 mt-28">
            ...
            <h1 data-aos="fade-left" data-aos-duration="1000" data-aos-delay="1200" className="text-left text-4xl font-extrabold font-karla text-gray-800">AMBININTSOA</h1>

            <h1 data-aos="fade-left" data-aos-duration="1000" data-aos-delay="1500" className="text-left text-4xl font-extrabold font-karla text-purple-700">LUCAS</h1>

            <h2 data-aos="fade-left" data-aos-duration="1000" data-aos-delay="1700" className=" text-left text-base font-base font-poppins py-6">Branch - IGGLIA 3</h2>
      ...
      <div data-aos="fade-left" data-aos-duration="1000" data-aos-delay="1600"className="absolute bg-purple-700 h-1 w-28 ml-64 mt-44 rounded-lg">
