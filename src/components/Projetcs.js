...
function Projects(props) {
  return (
    <div id="work" className="h-full col-span-7  p-10 pt-16 bg-gray-100  "> 
      <div className=" h-full w-full grid grid-cols-3 space-x-14">
        <div className="col-span-1  m-3 ml-0 h-full w-full ">
          ...
          <p className="text-left text-3xl font-extrabold font-righteous text-purple-700 pt-6  " data-aos="fade-right" data-aos-duration="1000" data-aos-delay="700">Chaptera </p>
        ...
        <div className="col-span-2  mr-3 my-2 h-full ">
          ...
          <br/>Tech web project - 2021 (Fisrt web project)
